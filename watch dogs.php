...
<style>
    header{
        width: 100%;
        height: 60vh;
        background-image: url(image/pc/watchdogs/w1.jpg);
    ...
    body{
        ...
        <div id="main" style="background-image: url(image/pc/watchdogs/w1.jpg);">
...
<div class="pics">
                ...
                <script>
                    var img = ["image/pc/watchdogs/w1.jpg","image/pc/watchdogs/w1.jpg",
            ...
            <h1>SHOP for Watch Dogs 2</h1>
                <div class="shop_this">
                    ...
                    <p>
                        ...
                        <form action="x_box1.php" method="post">
                            <span>Rs 1499</span>
                        </form>
                ...
                <script type="text/javascript">
                    ...
                    var images = ["image/pc/watchdogs/w1.jpg","image/pc/watchdogs/w1.jpg",
                                  "image/pc/watchdogs/w1.jpg"]
